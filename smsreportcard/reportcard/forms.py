...
class StudentForm(ModelForm):
	...
	#course = forms.CharField(max_length = 50, widget=forms.RadioSelect, choices = get_course())
	...
	class Meta:
		...
		widgets = {'first_name': forms.TextInput(attrs={"placeholder":"Sir Name"}),'middle_name': forms.TextInput(attrs={"placeholder":"Other Name"}),
			   ...
			   'Email': forms.TextInput(attrs={"placeholder":"Email Address ( Required )"}),
			   'phone_number': forms.TextInput(attrs={"placeholder":"P or G phone number (Required)"}),
...
class ReportForm(ModelForm):
	...
	remark = forms.CharField(max_length = 300, widget=forms.Textarea(attrs={"style":"width:670px ; height:100px"}) ,initial = "Good Work More Room for Improvement")
	class Meta:
		model = Report
...
class Report_contentForm(forms.Form):
	...
	exam_mark = forms.IntegerField(max_value =  200 ,label = "" , error_messages = errormsg_int , initial =23,widget=forms.TextInput(attrs={'class':'intform' , 'id':'intform', 'placeholder':'Examination Mark'}))
	test_mark = forms.IntegerField(max_value =  200 ,label = "" ,initial =30, widget=forms.TextInput(attrs={'class':'intform' , 'id':'intform','placeholder':'Test Mark'}))
	percentage = forms.IntegerField(max_value = 100 , required = False , label = "",initial =100 , widget=forms.TextInput(attrs={'class':'intform' ,'id':'intform' , 'placeholder':'Percentage'}))
	grade = forms.CharField(max_length = 1 , required = False , label = "" ,initial = "A",widget=forms.TextInput(attrs={'class':'grade','id':'grade', 'placeholder':'Grade'}))
